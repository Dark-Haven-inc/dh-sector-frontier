...
internal sealed class DH_MappingClientSideSetupCommand : LocalizedEntityCommands
{
    ...
    public override string Command => "mappingclientsidesetup_dh";
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        _actionSystem.LoadActionAssignments("/mapping_actions_dh.yml", false);
    }
}
